...
Batching same-process work is also the preferred way to avoid repeated CLI re-attach overhead and repeated 1-second session-start warning toasts across follow-up actions.
